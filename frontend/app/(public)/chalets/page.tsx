...
const ChaletPreviewCard = ({
  chalet,
  index,
}: {
  chalet: (typeof chaletData)[0];
  index: number;
}) => {
        ...
        <CardBody className="pt-0 space-y-4">
          ...
          <div>
            <h4 className="font-semibold mb-2 text-success flex items-center gap-2">
              <FaBullseye className="text-success" /> Équipements phares
            </h4>
            <div className="text-sm text-default-600">
              {chalet.features.slice(0, 3).join(" • ")}
              <span className="text-primary font-medium">
                {" "}
                et {chalet.features.length - 3} autres...
              </span>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              ...
              <div className="text-center lg:text-right space-y-3 bg-primary/5 p-4 rounded-xl">
                ...
                <div className="text-xs text-warning-600 bg-warning-50 dark:bg-warning-950/50 px-3 py-2 rounded-lg">
                  <FaExclamationTriangle className="inline mr-1" /> Évitez les
                  commissions LeBonCoin
                </div>
              </div>
            </div>
          </CardBody>
        ...
        <Card className="alpine-card">
          <CardBody className="p-8">
            ...
            <p className="text-lg text-default-600 mb-6 max-w-2xl mx-auto">
              ...
              unique. Contactez-nous pour personnaliser votre séjour et
              découvrir nos disponibilités.
            </p>
            ...
            <p className="text-xs text-default-500 mt-4 flex items-center justify-center gap-2">
              <MdChat /> Réponse garantie sous 24h • <GiMountains /> Au cœur des
              Vosges
            </p>
          </CardBody>
        </Card>
